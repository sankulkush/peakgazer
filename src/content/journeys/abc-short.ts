...
export const abcShort: Journey = {
  ...
  honestParagraph:
    "Seven days, five of them walking, to the Annapurna Sanctuary at 4,130m and back. Jeep access at both ends removes the two dullest road-walking days that longer versions include. You sleep low, climb to 4,130m for a sunrise, and descend. It is hard on two days and straightforward on the rest, and we tell you which two.",
